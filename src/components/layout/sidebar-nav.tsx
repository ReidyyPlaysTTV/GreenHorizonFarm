    ...
    return items.map((item) => {
        ...
        return (
            <SidebarMenuItem key={item.href}>
                ...
                >
                <item.icon className={cn("h-4 w-4 shrink-0 transition-transform group-hover:scale-110", isActive ? "text-primary-foreground" : "text-primary/70")} />
                <span className={cn("font-black text-[10px] uppercase tracking-[0.2em]", isActive ? "text-primary-foreground" : "text-foreground")}>{item.label}</span>
      ...
      <SidebarHeader className="p-6 group-data-[collapsible=icon]:p-2">
        <div className="flex items-center gap-4 transition-all duration-500 group-data-[collapsible=icon]:gap-0 group-data-[collapsible=icon]:justify-center">
            ...
            <div className="flex flex-col group-data-[collapsible=icon]:hidden overflow-hidden">
                ...
                <span className="text-[8px] uppercase text-primary font-black tracking-[0.4em] opacity-90">v2.5 Enterprise</span>
            </div>
        </div>
      </SidebarHeader>
      ...
      <SidebarContent className="px-4 space-y-8 scrollbar-hide">
        ...
        <div className="space-y-6">
            <div className="space-y-1.5">
                <p className="text-[9px] font-black text-primary/40 px-4 pb-2 uppercase tracking-[0.3em] group-data-[collapsible=icon]:hidden">Field Operations</p>
                {renderMenuItems(mainMenuItems)}
            </div>
            
            <div className="space-y-1.5">
                <p className="text-[9px] font-black text-primary/40 px-4 pb-2 uppercase tracking-[0.3em] group-data-[collapsible=icon]:hidden">Leadership Hub</p>
                {renderMenuItems(managementMenuItems)}
            </div>

            <div className="space-y-1.5">
                <p className="text-[9px] font-black text-primary/40 px-4 pb-2 uppercase tracking-[0.3em] group-data-[collapsible=icon]:hidden">Technical Control</p>
      ...
      <SidebarFooter className="p-6 mt-auto space-y-4 group-data-[collapsible=icon]:p-2">
        ...
        <div className="flex items-center gap-2 group-data-[collapsible=icon]:flex-col">
            <Button
                ...
                className="h-10 w-full rounded-2xl text-white/40 hover:text-primary hover:bg-white/5 border border-white/5 transition-all"
            >
